...
Version améliorée avec support multi-pages et options configurables.
"""
...
def apply_image_enhancements(image: np.ndarray, 
...
def main():
    ...
    if uploaded_file is not None:
        try:
            ...
            # Affichage des résultats si le traitement est terminé
            if st.session_state.processing_complete and st.session_state.processed_data is not None:
                ...
                # Interface d'édition avec navigation
